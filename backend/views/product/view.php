            ...
            [
                ...
                'value' => function ($model) {
                    if ($model->status_stock == 0) {
                        $status_stock = '<span class="text-danger">нет в наличии</span>';
                    } elseif ($model->status_stock == 1) {
                        $status_stock = '<span class="text-success">в наличии</span>';
                    } elseif ($model->status_stock == 2) {
                        $status_stock = '<span class="text-primary">ожидается</span>';
                    } elseif ($model->status_stock == 3) {
                        $status_stock = '<span class="text-warning">под заказ</span>';
                    }
                    return $status_stock ? $status_stock : null;
                },
                'format' => 'html'
            ],
            'keywords',
